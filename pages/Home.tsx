    ...
    <div className="w-full">
      ...
      <div className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url(${imageFeu})` }}
        ></div>
        ...
        <div className="container mx-auto px-6 relative z-20 text-center">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-display font-black text-white leading-tight mb-8"
          >
            UNE GÉNÉRATION<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             ...
             <motion.div 
               key={idx}
               whileHover={{ y: -10 }}
               className="bg-brand-black p-8 border border-white/5 hover:border-brand-orange/50 transition-colors"
             >
