    ...
    <div className="pt-20">
      ...
      <Section background="white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal className="ui-card bg-gray-50 p-8 md:p-12 rounded-lg border border-gray-200 shadow-xl" direction="left">
             ...
             <Stagger className="space-y-6" stagger={0.08}>
               ...
               <div className="bg-white p-6 rounded shadow-sm border-l-4 border-blue-600">
                 ...
                 <p className="font-bold text-lg mb-4">{CRN_CONTACT.email}</p>
                 <Button fullWidth onClick={() => window.open('https://paypal.com', '_blank', 'noopener,noreferrer')}>
                   Donner via PayPal
                 </Button>
               </div>
             </Stagger>
